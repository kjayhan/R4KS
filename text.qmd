...
In this chapter, we will learn how to analyze Korean text data using R. We will use Korea's 2022 Diplomatic White Paper (외교백서, *waegyo baekseo*) as an example text.
